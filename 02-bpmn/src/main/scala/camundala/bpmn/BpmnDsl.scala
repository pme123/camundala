...
trait BpmnDsl:
  ...
  def customTask[
    In <: Product : Encoder : Decoder : ApiSchema,
    Out <: Product : Encoder : Decoder : ApiSchema
  ](
     topicName: String,
     in: In = NoInput(),
     out: Out = NoOutput(),
  ...
  def singleEntry[
      In <: Product:  InOutCodec: ApiSchema,
      Out <: DmnValueType:  InOutCodec: ApiSchema: ClassTag
  ](
      decisionDefinitionKey: String,
      in: In,
      out: Out,
  ...
  def collectEntries[
      In <: Product:  InOutCodec: ApiSchema,
      Out <: DmnValueType:  InOutCodec: ApiSchema
  ](
      decisionDefinitionKey: String,
      in: In,
  ...
  given toCollectEntries[Out <: DmnValueType:  InOutCodec: ApiSchema]: Conversion[Seq[Out], CollectEntries[Out]] =
    CollectEntries(_)
  ...
  def messageEvent[
      Msg <: Product:  InOutCodec: ApiSchema
  ](
      messageName: String,
      in: Msg = NoInput(),
