...
object ProcessVariablesExtractor:
  ...
  def extractGeneral(generalVariablesFromError: Option[GeneralVariables] =
    None): GeneralVariableType =
    generalVariablesFromError
      ...
      .getOrElse:
        for
          ...
          regexHandledErrors   <-
            extractSeqFromArrayOrString(InputParams.regexHandledErrors, Seq.empty)
          // authorization
