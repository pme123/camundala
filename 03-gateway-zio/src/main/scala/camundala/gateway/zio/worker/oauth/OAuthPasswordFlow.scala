package camundala.gateway.zio.worker.oauth

import camundala.domain.InOutDecoder
import camundala.gateway.zio.worker.*
import camundala.gateway.zio.worker.CamundalaWorkerError.ServiceAuthError
import sttp.client3.*
